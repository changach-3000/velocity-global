...
migrate((app) => {
  ...
  const record0 = new Record(collection);
    ...
    record0.set("instructor_name", "Equipment Leasing Expert");
    record0.set("price", 99.99);
    record0.set("duration_hours", 6);
    record0.set("learning_outcomes", "Risk identification and classification, Credit analysis and tenant evaluation, Residual value risk management, Risk mitigation strategies");
