...
migrate((app) => {
  ...
  const record1 = new Record(collection);
    ...
    record1.set("description", "US GAAP lease classification, operating vs finance leases, measurement principles");
    record1.set("order", 2);
  ...
  const record2 = new Record(collection);
    ...
    record2.set("description", "Journal entries, financial statement presentation, transition guidance");
    record2.set("order", 3);
  ...
  const record3 = new Record(collection);
    ...
    record3.set("title", "IFRS 16 vs ASC 842");
    record3.set("description", "Comparative analysis, key differences, convergence efforts");
    record3.set("order", 4);
